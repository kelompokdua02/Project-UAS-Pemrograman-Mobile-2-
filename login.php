...
<html lang="en" data-bs-theme="auto">
  ...
  <head>
    ...
    <title>CoffeeShop - Aplikasi Pemesanan Makanan dan Minuman</title>
...
<main class="form-signin w-100 m-auto">
    ...
    <i class="bi bi-cup-hot fs-1"></i>
        ...
        <div class="form-floating">
            <input name="username" type="email" class="form-control" id="floatingInput" aria-describedby="inputGroupPrepend" placeholder="name@example.com"required> 
        ...
        <div class="invalid-feedback">
                Kata kunci salah. Silahkan coba lagi.
        </div>                
